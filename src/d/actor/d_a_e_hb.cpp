...
typedef dusk::frame_interp::DualBuffer<cXyz, STALK_SEGMENT_COUNT> StalkInterp;
#endif
...
static int daE_HB_Draw(e_hb_class* i_this) {
    ...
    IF_DUSK(dusk::frame_interp::get<StalkInterp>(i_this).writeback(i_this->stalkLine.getPos(0), STALK_SEGMENT_COUNT));
